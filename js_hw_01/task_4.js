...
let droids = prompt ("Сколько дроидов Вы желаете приобрести?")
let credits = 35500;
let pricePerDroid = 3000;
let totalPrice = droids * pricePerDroid;
...
if (droids === null){
    ...
    alert (`Вы купили ${droids} дроидов,на счету осталось ${credits - totalPrice} кредитов`)
}
